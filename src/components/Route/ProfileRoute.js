...
const CurriculumProfile = lazy(() => import('../ui/__user_ui/profiles/Profile').then(module => ({default: module.CurriculumProfile})))
...
const ProfileRoute = ({translation}) => {
    return (
        <Fragment>
            ...
            <Route path={`${translation.language["route.profile.curriculum"]}:id`} exact render={() => <CurriculumProfile translation={translation}/>}/>
            {/*<Redirect to={'/'}/>*/}
