...
const TeacherRoom = lazy(() => import('../ui/__user_ui/teacher/Teacher').then(module => ({ default: module.TeacherRoom })))
...
const StudentRoom = lazy(() => import('../ui/__user_ui/student/Student').then(module => ({ default: module.StudentRoom })))
                    ...
                    <div className={classes.toolbar} />
                    {
                        <Suspense fallback={<Skeleton/>}>
                            <Switch>
                                ...
                                <Route path='/teacher/rooms' exact render={() => <TeacherRoom/>}/>
                                ...
                                <Route path='/student/rooms' exact render={() => <StudentRoom/>}/>
