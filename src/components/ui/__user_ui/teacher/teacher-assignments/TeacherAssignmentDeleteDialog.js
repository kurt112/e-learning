...
import {DeleteAssignmentFail, DeleteAssignmentSuccess} from "../../../../../__Messages/TeacherAssignmentMessage";
...
const mapDispatchToState = (dispatch) => {
    return {
        ...
        dialogId: (event) => dispatch(actions.dialogId(event.target.value, Teacher_Assignment_Delete)),
